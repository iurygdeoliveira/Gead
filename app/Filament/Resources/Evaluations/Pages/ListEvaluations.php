    ...
    public function getTabs(): array
    {
        ...
        return [
            'farmacia' => Tab::make('Farm.')
                ...
                ->badge((clone $baseQuery)->whereHas('courseClassDiscipline.courseClass.course', fn ($q) => $q->where('name', 'ilike', '%Farmácia%'))->count()),
            'enfermagem' => Tab::make('Enfer.')
                ...
                ->badge((clone $baseQuery)->whereHas('courseClassDiscipline.courseClass.course', fn ($q) => $q->where('name', 'ilike', '%Enfermagem%'))->count()),
            'informatica' => Tab::make('Infor.')
                ...
                ->badge((clone $baseQuery)->whereHas('courseClassDiscipline.courseClass.course', fn ($q) => $q->where(fn($sub) => $sub->where('name', 'ilike', '%Informática%')->orWhere('name', 'ilike', '%Informatica%')))->count()),
            'gpi' => Tab::make('GPI')
                ...
                ->badge((clone $baseQuery)->whereHas('courseClassDiscipline.courseClass.course', fn ($q) => $q->where(fn($sub) => $sub->where('name', 'ilike', '%GPI%')->orWhere('name', 'ilike', '%Gestão da Produção Industrial%')))->count()),
            'tads' => Tab::make('TADS')
                ...
                ->badge((clone $baseQuery)->whereHas('courseClassDiscipline.courseClass.course', fn ($q) => $q->where(fn($sub) => $sub->where('name', 'ilike', '%TADS%')->orWhere('name', 'ilike', '%Análise e Desenvolvimento de Sistema%')))->count()),
            'pcp' => Tab::make('PCP')
                ...
                ->badge((clone $baseQuery)->whereHas('courseClassDiscipline.courseClass.course', fn ($q) => $q->where(fn($sub) => $sub->where('name', 'ilike', '%PCP%')->orWhere('name', 'ilike', '%Planejamento e controle da produção%')))->count()),
            'eja' => Tab::make('EJA')
                ->query(fn ($query) => $query->whereHas('courseClassDiscipline.courseClass.course', fn ($q) => $q->where('name', 'ilike', '%Operador de Computador%')))
                ->badge((clone $baseQuery)->whereHas('courseClassDiscipline.courseClass.course', fn ($q) => $q->where('name', 'ilike', '%Operador de Computador%'))->count()),
            'analises_clinicas' => Tab::make('Análises')
                ...
                ->badge((clone $baseQuery)->whereHas('courseClassDiscipline.courseClass.course', fn ($q) => $q->where(fn($sub) => $sub->where('name', 'ilike', '%Análises Clínicas%')->orWhere('name', 'ilike', '%Analises Clinicas%')))->count()),
        ];
    }
}
